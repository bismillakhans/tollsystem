...
from mainapp.forms import SignUpForm, ProfileForm, UserForm, VehicleForm, BankForm, VehicleNumberForm
...
def vehicle_manually(request):
    if request.method == 'POST':
        form = VehicleNumberForm(request.POST)
