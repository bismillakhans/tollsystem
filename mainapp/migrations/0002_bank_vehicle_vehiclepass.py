# Generated by Django 2.2.6 on 2019-11-06 06:12
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('car_number', models.CharField(blank=True, max_length=30, null=True)),
                ('date', models.DateTimeField(auto_now_add=True)),
                ('file_upload', models.FileField(upload_to='uploads/', verbose_name='Upload Resumes')),
            ],
        ),
        migrations.CreateModel(
            name='Vehicle',
            fields=[
                ...
                ('model_Variant', models.CharField(blank=True, max_length=30)),
